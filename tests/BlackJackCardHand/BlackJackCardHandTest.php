...
class BlackJackCardHandTest extends TestCase
{
    ...
    //     $BlackJackCardHand->addBankHand($deck);

    //     $this->assertEquals($exp, $BlackJackCardHand->GetBankHand());

    //     //Testing AddToBankHand method.
    //     $BlackJackCardHand->addToBankHand(['[' . '8' . "\u{2660}" . ']']);
    //     $expBank = ['[' . 'A' . "\u{2660}" . ']', '[' . '7' . "\u{2660}" . ']', '[' . '8' . "\u{2660}" . ']'];

    //     $this->assertEquals($expBank, $BlackJackCardHand->getBankHand());
    //     $this->assertEquals($expBank, $BlackJackCardHand->apiBankHand());
    // }
    ...
    //     $BlackJackCardHand->addToBankHand($deck);
    //     $BlackJackCardHand->addToHand($deck);

    //     $this->assertEquals($exp, $BlackJackCardHand->countPlayerPoints());
    //     $this->assertEquals($exp, $BlackJackCardHand->countBankPoints());
    // }
    ...
    //     $BlackJackCardHand->addToBankHand($bankWinnerDeck);
    //     $BlackJackCardHand->addToHand($bankWinnerDeck);

    //     $this->assertEquals($expBankWins, $BlackJackCardHand->winner());

    //     //Testing if player wins.
    //     $BlackJackCardHand->addToHand(['[' . 'A' . "\u{2660}" . ']']);

    //     $expPlayerWins = "Spelaren vann!";

    //     $this->assertEquals($expPlayerWins, $BlackJackCardHand->winner());

    //     //If bank gets to much points.
    //     $bankLooseDeck = ['[' . 'J' . "\u{2660}" . ']', '[' . 'K' . "\u{2660}" . ']', '[' . 'Q' . "\u{2660}" . ']', '[' . 'A' . "\u{2665}" . ']'];
    //     $BlackJackCardHand->addToBankHand($bankLooseDeck);
